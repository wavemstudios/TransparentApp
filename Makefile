...
executable: PaymentSample.c
	...
	$(CC) PaymentSample.c emvTagList.c ledBuzzerController.c emvPaymentLib.a -o PaymentSample -lfeclr -lfepkcs11 -lleds -lbuzzer -lL2Manager -lL2Base -lL2PayPass -lL2Paywave -lL2Entrypoint -lL2ExpressPay -lL2Discover -lL2FeigHAL -lfememcard -lpthread -lssl -lcrypto
	fesign --module opensc-pkcs11.so --pin 648219 --slotid 1 --keyid 00a0 --infile PaymentSample
	
.PHONY: clean
clean:
	rm -f PaymentSample PaymentSample.backup emvPaymentApp.o sslCall.o emvTagList.o asn1.o tlv.o emvPaymentLib.a
