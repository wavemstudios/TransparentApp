...
executable: PaymentSample.c
	...
	$(CC) PaymentSample.c emvTagList.c ledBuzzerController.c apduListener.c emvPaymentLib.a -o PaymentSample -lfeclr -lleds -lbuzzer -lL2Manager -lL2Base -lL2PayPass -lL2Paywave -lL2Entrypoint -lL2ExpressPay -lL2Discover -lL2FeigHAL -lfememcard -lpthread -lssl -lfepkcs11 -lcrypto
